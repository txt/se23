  ...
  <p align=center><a href="/README.md#top"><img  align=right width=900 src="/docs/img/banner.png"></a></p><br clear=all>
...
In this subject, students will be taught about the start of the art in SE and how how to:
...
It is each student's responsibility to join the class Discord  group "se23". Till Friday week1, the link to join there is [here](https://discord.gg/wpeE2Tmm).
...
- 1 final exam (for those that want to replace the lowest mark on one of their mid-terms).
- 1 essay (due Dec4). You will have all the materials for this exam by mid-semester.
...
someone else'e code  (groups of 4 people, working in public Github repos-- not NCSU GH):
 This will demonstrate the important of documentation, 
  ...
  - Project1: you review five projects done previsously in this subjects, select one, then show you can get it
    running.
  - Project2: you'll significantly extend the Project1 code
  - Projects3: you will swtich to someone else's project2 code (and you'll get to bid for what Proj2 you want to do). 
